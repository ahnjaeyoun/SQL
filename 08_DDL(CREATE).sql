...
-- 오라클에서의 객체 : 테이블(TABLE), 뷰(VIEW), 시퀸스(SEQUENCE),
...
-- INSERT INTO 테이블명 VALUES(갑1, 갑2, ...);

INSERT INTO "MEMBER" VALUES('MEMO1', '1234ABC', '홍길동', '991213-1234567', DEFAULT);
...
INSERT INTO "MEMBER" VALUES('MEMO2', 'A153478', '전지연', '945213-1234567', DEFAULT);
INSERT INTO "MEMBER" VALUES('MEMO3', 'B154775', '김홍기', '989213-1234657', SYSDATE);

INSERT INTO "MEMBER"(MEMBER_ID, MEMBER_PWD, MEMBER_NAME)
VALUES('ME04', 'TDS1213', '이지연');
...
INSERT INTO MEMBER2 VALUES('MEM01', 'PASS01', '고길순', 01012341234);
...
VALUES(1, 'USER01', 'PASS01', '홍길동', '남', '010-1234-4567', 'hong1234@kh.or.kr');

INSERT INTO USER_USED_NN
VALUES(NULL, NULL, NULL, NULL, NULL, '010-1234-4567', 'hong1234@kh.or.kr');
...
INSERT INTO USER_USED_UK
VALUES(1, NULL, 'PASS01', '홍길동', '남', '010-1234-4567', 'hong1234@kh.or.kr');
--> 아이디에 NULL 값 삽입 가능.
...
CREATE TABLE USER_USED_UK2(
	...
	PHONE VARCHAR2(30),
	EMAIL VARCHAR2(50),
	CONSTRAINT USER_ID_NAME_U UNIQUE(USER_ID, USER_NAME) -- 테이블 레벨(제약조건명 지정)
);
...
INSERT INTO USER_USED_UK2
VALUES(1, 'USER02', 'PASS01', '홍길동', '남', '010-1234-4567', 'hong1234@kh.or.kr');

INSERT INTO USER_USED_UK2
VALUES(1, 'USER01', 'PASS01', '고길동', '남', '010-1234-4567', 'hong1234@kh.or.kr');
...
CREATE TABLE USER_USED_PK(
	USER_NO NUMBER CONSTRAINT USER_USED_PK PRIMARY KEY, -- 컬럼레벨
	USER_ID VARCHAR2(20),
	USER_PWD VARCHAR2(30),
	USER_NAME VARCHAR2(30),
	GENDER VARCHAR2(10),
...
INSERT INTO USER_USED_PK
VALUES(1, 'USER02', 'PASS01', '이순신', '남', '010-4324-5724', 'LEE1234@kh.or.kr');
-- 무결성 제약 조건(KH.USER_ID_NAME_U)에 위배됩니다
--> 기본키 중복으로 오류


INSERT INTO USER_USED_PK
VALUES(NULL, 'USER02', 'PASS01', '이순신', '남', '010-4324-5724', 'LEE1234@kh.or.kr');
--무결성 제약 조건(KH.USER_ID_NAME_U)에 위배됩니다
-- 기본기가 NULL이므로 오류
...
CREATE TABLE USER_USED_PK2(
	...
	EMAIL VARCHAR2(50),
	-- 테이블레벨
	CONSTRAINT USER_NO_PK PRIMARY KEY(USER_ID, USER_NO) -- 복합키
);
...
VALUES(1, 'USER01', 'PASS01', '홍길동', '남', '010-1234-4567', 'hong1234@kh.or.kr', 10);

INSERT INTO USER_USED_FK
VALUES(2, 'USER02', 'PASS01', '홍길동', '남', '010-1234-4567', 'hong1234@kh.or.kr', 10);

INSERT INTO USER_USED_FK
VALUES(3, 'USER03', 'PASS01', '홍길동', '남', '010-1234-4567', 'hong1234@kh.or.kr', 30);

INSERT INTO USER_USED_FK
VALUES(4, 'USER04', 'PASS01', '홍길동', '남', '010-1234-4567', 'hong1234@kh.or.kr', NULL);
--> NULL 사용 가능

INSERT INTO USER_USED_FK
VALUES(1, 'USER01', 'PASS01', '홍길동', '남', '010-1234-4567', 'hong1234@kh.or.kr', 50);
-- ORA-00001: 무결성 제약 조건(KH.SYS_C008431)에 위배됩니다
...
INSERT INTO USER_USED_CHECK
VALUES(2, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-4567', 'hong1234@kh.or.kr');
...
CREATE TABLE USER_TEST(
	USER_NO NUMBER CONSTRAINT USER_TEST PRIMARY KEY,
	USER_ID VARCHAR(20) CONSTRAINT USER_ID UNIQUE,
	...
	STATUS VARCHAR(3) DEFAULT 'N' CONSTRAINT NN_USER_TEST_STATUS NOT NULL,
...
VALUES(1, 'USER01', 'PASS01', '940220-2039482', '여', '010-7854-1542', '서울시 성북구','N');

INSERT INTO USER_TEST
VALUES(2, 'USER02', 'PASS01', '970910-1039482', '남', '010-7864-1542', '서울시 강남구','N');

INSERT INTO USER_TEST
VALUES(3, 'USER03', 'PASS01', '920617-2039482', '여', '010-7874-1542', '서울시 동대문구','N');

INSERT INTO USER_TEST
VALUES(4, 'USER04', 'PASS01', '940220-1089482', '남', '010-7854-1542', '경기도 김포시','Y');

INSERT INTO USER_TEST
VALUES(5, 'USER05', 'PASS01', '940220-2035722', '여', '010-7854-1542', '서울시 성북구','N');
...
-- 제약조건, 코멘트는 복사가되지 않기 때문에 별도 추가 작업이 필요하다!
...
ALTER TABLE LOCATION ADD CONSTRAINT LO_NATIONAL_CODE
