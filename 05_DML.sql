...
-- 테이블에 값을 삽입하거나 (INSERT), 수정하고나(UPDATE), 삭제(DELETE) 하는 구문
...
-- 테이블에있는 모든 컬럼에 대한 값을 INSERT 할 때 사용
-- INSERT하고자 하는 컬럼이 모든 컬럼인 경우 컬럼명 생략 가능.
-- 단, 컬럼의 순서를 지켜서 VALUES에 값을 기입해야 함.

INSERT INTO EMPLOYEE2
VALUES(900, '장채현', '901230-2345678', 'vnm1994wodbs@nvaer.com', '01012345432', 'D1', 'J7', 'S3',4300000, 0.2, 200,
SYSDATE, NULL, 'N');
...
VALUES (900, '장채현', '901230-2345678', 'vnm1994wodbs@nvaer.com', '010123456432', 'D1', 'J7', 'S3', 4300000);
...
INSERT INTO EMP_M02 VALUES (900, '곽두원', '561016-1234567', 'kk@kh.or.kr',
