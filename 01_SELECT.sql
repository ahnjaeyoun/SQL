 ...
 *  이 때, 조회된 행들의 집합을 "RESULT SET" (조회의 집합) 이라고 한다.
 * 
...
SELCET EMP_NAME + 10 FROM EMPLOYEE;
-- ORA-01722 : 수치가 부적합합니다.
-- 산술연산은 숫자(NUMBER 타입)만 가능하다!

SELCET EMP_ID + 10 FROM EMPLOYEE;
...
SELECT SYSDATE EMP_NO, EMP_NAME, EMAIL, DEPT_CODE, HIRE_DATE, SALARY
FROM EMPLOYEE
