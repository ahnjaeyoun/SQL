...
CREATE USER ajy_sample IDENTIFIED BY 1234;
...
-- [권한 부여 작성법]
-- GRANT 권한, 권한, ... TO 사용자명;
GRANT CREATE SESSION TO ajy_sample;
...
GRANT CREATE TABLE TO ajy_sample;

ALTER USER ajy_sample DEFAULT TABLESPACE
...
GRANT CONNECT, RESOURCE TO ajy_sample;
...
-- kh / ajy_sample 사용자 계정끼리 서로 객체 접근 권한 부여
...
-- 2. (kh) ajy_sample계정에 EMPLOYEE 테이블 조회 권한 부여

-- [객체 권한 부여 방법]
-- GRANT 객체권한 ON 객체명 TO 사용자명;
GRANT SELECT ON EMPLOYEE TO ajy_sample;
...
REVOKE SELECT ON EMPLOYEE FROM ajy_sample;
